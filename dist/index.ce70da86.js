...
})({"5RpUT":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "74798c74ce70da86";
"use strict";
...
},{}],"chb94":[function(require,module,exports) {
...
const wrapElements = (t, e, r)=>{
    t.forEach((t)=>{
        const o = document.createElement(e);
        o.classList = r, t.parentNode.appendChild(o), o.appendChild(t);
    });
};
...
const initSmoothScrolling = ()=>{
    ...
    const t = (e)=>{
        lenis.raf(e), requestAnimationFrame(t);
    };
    requestAnimationFrame(t);
}, scroll = ()=>{
    fadePop.forEach((t)=>{
        const e = t.querySelectorAll(".char");
        e.forEach((t)=>(0, _gsap.gsap).set(t.parentNode, {
                perspective: 1e3
            })), (0, _gsap.gsap).fromTo(e, {
        ...
        for (const [t, r] of e.entries())(0, _gsap.gsap).fromTo(r.querySelectorAll(".char"), {
        ...
        for (const [t, o] of e.entries())r.fromTo(o.querySelectorAll(".char"), {
            "will-change": "transform",
        ...
        for (const t of e){
            const e = t.querySelectorAll(".char"), r = e.length;
            (0, _gsap.gsap).fromTo(e, {
                "will-change": "transform, filter",
                transformOrigin: "50% 100%",
                scale: (t)=>{
                    const e = t < Math.ceil(r / 2) ? t : Math.ceil(r / 2) - Math.abs(Math.floor(r / 2) - t) - 1;
                    return (0, _gsap.gsap).utils.mapRange(0, Math.ceil(r / 2), .5, 2.1, e);
                },
                y: (t)=>{
                    const e = t < Math.ceil(r / 2) ? t : Math.ceil(r / 2) - Math.abs(Math.floor(r / 2) - t) - 1;
                    return (0, _gsap.gsap).utils.mapRange(0, Math.ceil(r / 2), 0, 60, e);
                },
                rotation: (t)=>{
                    const e = t < Math.ceil(r / 2) ? t : Math.ceil(r / 2) - Math.abs(Math.floor(r / 2) - t) - 1;
                    return t < r / 2 ? (0, _gsap.gsap).utils.mapRange(0, Math.ceil(r / 2), -4, 0, e) : (0, _gsap.gsap).utils.mapRange(0, Math.ceil(r / 2), 0, 4, e);
                },
    ...
    obfText.forEach((e)=>{
        e.querySelectorAll(".char").forEach((r, o)=>{
            let a = r.innerHTML;
            (0, _gsap.gsap).fromTo(r, {
                opacity: 0
            }, {
                duration: .03,
                ...
                scrollTrigger: {
                    ...
                    onEnter: ()=>(0, _gsap.gsap).set(r, {
                            opacity: 0
                        })
                }
            });
        });
    }), fizzLetters.forEach((t)=>{
        const e = t.querySelectorAll(".char");
        (0, _gsap.gsap).fromTo(e, {
            "will-change": "opacity",
            opacity: 0,
...
},{}]},["5RpUT","chb94"], "chb94", "parcelRequire2524")

//# sourceMappingURL=index.ce70da86.js.map
